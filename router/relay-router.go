...
func SetRelayRouter(router *gin.Engine) {
	...
	modelsRouter.Use(middleware.MaasApiKeyAuth())
	{
	...
	geminiRouter.Use(middleware.MaasApiKeyAuth())
	{
	...
	geminiCompatibleRouter.Use(middleware.MaasApiKeyAuth())
	{
	...
	relayV1Router.Use(middleware.MaasApiKeyAuth())
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	relayV1Router.Use(middleware.MaasTenantRateLimit())
	{
	...
	relaySunoRouter.Use(middleware.MaasApiKeyAuth(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.MaasApiKeyAuth())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.MaasApiKeyAuth(), middleware.Distribute())
	{
